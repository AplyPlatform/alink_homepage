...
$(function(){ 
  ...
  function updateMindSet() {
    ...
    let bodyStr = mindStr
                  ...
                  + '<a-troika-text id="comment_a1" position="0 0.54 0.1" value="정은혜 작가의 증강현실 프로필 입니다." color="white" align="right" font="../objet/assets/NanumGothic.ttf" font-size="0.08" animation="property: scale; to: 1.1 1.1 1.1; dir: alternate; loop: true"></a-troika-text>'
                  ...
                  + '<a-troika-text id="comment_a2" max-width="1" line-height="1.5" position="0 0.40 0.1" value="하하하" color="white" align="center" font="../objet/assets/NanumGothic.ttf" font-size="0.05"></a-troika-text>'
