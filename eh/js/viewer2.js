...
$(function(){ 
  ...
  function updateMindSet() {
    let mindStr = '<div><a-scene loading-screen="dotsColor: red; backgroundColor: black" smooth=true mindar-image="imageTargetSrc: ./assets/eh3.mind; filterMinCF:0.0001; filterBeta: 0.001;"';
    ...
    let bodyStr = mindStr
                  ...
                  + '<a-plane id="aplane" class="clickable" geometry="primitive:plane;width:1;height:0.7;" position="0 0 0" material="shader:gif;src:url(./assets/out.gif);opacity:1.0"></a-plane>'
