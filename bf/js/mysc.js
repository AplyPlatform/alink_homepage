 $(function(){ 
  ...
  function updateMindSet(mindname) {
    let mindStr = '<div><a-scene mindar-image="imageTargetSrc: /arink/arinkassets/mysc.mind;';
    ...
    let bodyStr = mindStr
                  ...
                  + '<a-assets><a-asset-item id="raccoonModel" src="/arink/arinkassets/mysc.glb"></a-asset-item></a-assets>'
