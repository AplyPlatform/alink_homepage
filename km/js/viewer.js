...
$(function(){ 
  ...
  function updateMindSet() {
    let mindStr = '<div><a-scene mindar-image="imageTargetSrc: ./assets/target.mind; filterMinCF:0.0001; filterBeta: 0.1;"';
    ...
    let bodyStr = mindStr
                  ...
                  + '<a-plane geometry="primitive:plane;width:1;height:1;" position="0 0 0" material="shader:gif;src:url(/objet/assets/9.gif);opacity:1"></a-plane>'
